...
app.use('/bm', AuthCacheMW({ permittedUrls: ['/{app}/flow/utils/{id}/init', '/auth/login', '/{app}/faas/utils/{id}/statusChange'], secret: config.secret, decodeOnly: true }), require('./controllers'));
